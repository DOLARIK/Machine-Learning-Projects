...
n = size(X,2);
    ...
    for i = 1:n    
        ...
        for l = 1:L
            ...
            if l == 1
                C{i,l} = convLayer(X{i},t{l},P{l},S{l},s{l},Kernel_Size{l},0);
            else
                C{i,l} = convLayer(C{i,l-1},t{l},P{l},S{l},s{l},Kernel_Size{l},0);
            end
        end
        
        % Flatten
        
        C{i,L+1} = squash(C{i,L});                          % Input Layer of Fully Connected Layers
        ...
        for l = 1:La+2
            ...
            if l == La+2                                % Output Layer
                C{i,L + l} = C{i,L+l-1}*t{L+l-1};
                pred(i,:) = sigmoid(C{i,L+l});
            end
